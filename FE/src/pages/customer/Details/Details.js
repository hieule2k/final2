...
import { AiOutlineWifi, AiOutlineShareAlt, AiOutlinePhone, AiOutlineHeart, AiOutlineArrowRight, AiFillStar } from 'react-icons/ai';
            ...
            <p className={cx("description-desc")}>
              ...
              {description}
                    ...
                    <div className={cx('safety')}>
                        <h2 className={cx('heading', 'safety-heading')}>Safety and Hygiene</h2>
                    ...
                    <div className={cx('nearby-services__container')}>
                        <h2 className={cx('heading ', 'nearby-sevices__heading')}>Nearby Services</h2>
                        ...
                        <Button black mediumx rounded className={cx('nearby-services__button')} href="https://www.google.com/maps/?hl=vi">
                            Show On Map
                        </Button>
                    </div>
                ...
                <div className={cx('col-right')}>
                    <DetailTable reserve title="Price Range" detailsHotel={detailsHotel}></DetailTable>
