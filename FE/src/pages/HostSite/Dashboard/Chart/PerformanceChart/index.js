...
const dollarFormatter = (value) => `$ ${Intl.NumberFormat('us').format(value).toString()}`;
            ...
            <div className="md:flex justify-between">
                <div>
                    <Flex justifyContent="start" className="space-x-0.5" alignItems="center">
                        ...
                        <Icon icon={InformationCircleIcon} variant="simple" tooltip="Shows day-over-day (%) changes of past performance" />
                    </Flex>
